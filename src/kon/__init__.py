...
from typing import Iterable, List, Optional, Protocol, TypeVar, cast, Dict, Union, runtime_checkable
import textwrap
...
__all__ = ('dumps', 'loads', 'dump', 'load', 'KonParser', 'MultilineStringBehaviour')
